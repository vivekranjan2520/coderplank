    ...
    <div class="row">
      <div class="col-lg-8">
           <div class="hero-post shadow">
                 <a href="java.html"> <img class="img-fluid" alt="image" src='<spring:url value="/resources/img/java.png"/>'></a>
