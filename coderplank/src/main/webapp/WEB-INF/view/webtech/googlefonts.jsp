			...
			<div class="row">
				<div class="col-lg-8">
					<div class="hero-post shadow">
						<img class="img-fluid" alt="image" src='<spring:url value="/resources/img/googlefonts.png"/>'>
						...
						<div class="hero-post-content">
							<div class="row">
								...
								<div class="col-md-12">
									<h2>What is Google fonts?</h2>
								</div>
							</div>
						</div>
						<p class="m-2">
							Google fonts launched in 2010 as Google Web Fonts, Google Fonts
							is a collection of application programming interfaces that allow
							users to use web fonts on their website. This service is hosted
							by Google, and all of the fonts and bandwidth is free.<a
								href="https://fonts.google.com/
">googlefonts.com</a>
						</p>
						<p class="m-2">
							Go to google font website and select which ever font you like and
							left hand side there is a option embed copy the link between the
							head element of html.Write code in css file where you want.Just
							like you want to add to whole body then create a css file and
							write these <b> body{font-family: 'Oswald', sans-serif;}</b>
						</p>
					</div>
