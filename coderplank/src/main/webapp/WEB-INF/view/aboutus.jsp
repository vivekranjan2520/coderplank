...
<body>
	...
	<h1 style="margin: 100px; text-align: center;">coderplank is a
		website which show the trending technology,website. In future it also
		provide java and javascript tutorial and many more programming
		languages.</h1>
